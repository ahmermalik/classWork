...
function ColumnSet(columns, options) {
     ...
     *
     * It can also be a function - iterator, to be called for every column, passing in {@link helpers.Column Column} as `this` context,
     * and plus as a single parameter. The function would return a truthy value for every column that needs to be skipped.
     *
     * @returns {string}
     * Comma-separated assignments of excluded columns.
     *
     * @example
     *
